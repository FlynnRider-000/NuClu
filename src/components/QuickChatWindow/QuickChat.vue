<template>
    <div class="quickChat">
        ...
        <template v-slot:header> 
            <img :src="participants[0].imageUrl" alt="" class="sc-header--img">
...
.quickChat .sc-header--title {
  font-size: 17px !important;
}
.quickChat .sc-message {
  width: 250px !important;
}
.quickChat .sc-user-input--button > svg{
  width: 20px;
  height: 20px;
}
.quickChat .sc-message--emoji {
  font-size: 20px !important;
}
.quickChat .sc-chat-window {
  width: 300px !important;
  z-index: 1000;
  border: 1px solid rgb(78, 140, 255);
  bottom: 10px !important;
}
.quickChat .sc-chat-window .sc-user-input--text {
  width: 200px !important;
}
.quickChat .sc-user-input--emoji-icon-wrapper > svg {
  width: 20px;
  height: 20px;
}
.quickChat .sc-message .sc-message--text {
  padding: 5px 10px;
  max-width: calc(100% - 50px) !important;
}
.quickChat .sc-message .sc-message--text-content {
  font-size: 14px;
  line-height: 1.3 !important;
}
.quickChat .sc-message--content.sent .sc-message--text-content a {
  color: white !important;
  text-decoration: underline;
  text-decoration-color: white;
}
.quickChat .sc-message p {
  margin:0px !important;
}
.quickChat .sc-launcher {
  display: none;
}
.quickChat .sc-header--img {
  width: 60px;
}
